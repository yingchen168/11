...
## Documents
- Document attachments should be extracted automatically before analysis.
- PDF and spreadsheet files should be read from Telegram uploads by running `/root/.agents/skills/documents/scripts/extract_document.py` first.
